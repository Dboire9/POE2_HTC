package main.java.core.Item_modifiers.TwoHand_Item_modifiers.Quarterstaves_Items_modifiers;
...
// PREFIXES
        ...
        FIRE_DAMAGE_FLAT = new Modifier(
            ...
            List.of(
                new ModifierTier("Heated", 1, 800, new Pair<>(2, 4), new Pair<>(5, 7), "", ""),
                new ModifierTier("Smouldering", 8, 800, new Pair<>(6, 9), new Pair<>(10, 16), "", ""),
                new ModifierTier("Smoking", 16, 800, new Pair<>(11, 17), new Pair<>(19, 28), "", ""),
                new ModifierTier("Burning", 33, 800, new Pair<>(19, 27), new Pair<>(30, 42), "", ""),
                new ModifierTier("Flaming", 46, 800, new Pair<>(30, 37), new Pair<>(45, 56), "", ""),
                new ModifierTier("Scorching", 54, 800, new Pair<>(39, 53), new Pair<>(59, 80), "", ""),
                new ModifierTier("Incinerating", 60, 480, new Pair<>(56, 70), new Pair<>(84, 107), "", ""),
                new ModifierTier("Blasting", 65, 320, new Pair<>(73, 97), new Pair<>(112, 149), "", ""),
                new ModifierTier("Cremating", 75, 200, new Pair<>(102, 130), new Pair<>(155, 198), "", ""),
                new ModifierTier("Carbonising", 81, 80, new Pair<>(135, 156), new Pair<>(205, 236), "", "")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "FireDamage",
        ...
        COLD_DAMAGE_FLAT = new Modifier(
            ...
            List.of(
                new ModifierTier("Frosted", 1, 900, new Pair<>(2, 3), new Pair<>(4, 6), "", ""),
                new ModifierTier("Chilled", 8, 900, new Pair<>(5, 8), new Pair<>(9, 14), "", ""),
                new ModifierTier("Icy", 16, 900, new Pair<>(10, 14), new Pair<>(15, 23), "", ""),
                new ModifierTier("Frigid", 33, 900, new Pair<>(16, 23), new Pair<>(25, 35), "", ""),
                new ModifierTier("Freezing", 46, 900, new Pair<>(25, 30), new Pair<>(38, 46), "", ""),
                new ModifierTier("Frozen", 54, 900, new Pair<>(32, 43), new Pair<>(49, 66), "", ""),
                new ModifierTier("Glaciated", 60, 540, new Pair<>(46, 57), new Pair<>(70, 88), "", ""),
                new ModifierTier("Polar", 65, 360, new Pair<>(60, 80), new Pair<>(92, 121), "", ""),
                new ModifierTier("Entombing", 75, 225, new Pair<>(84, 107), new Pair<>(126, 161), "", ""),
                new ModifierTier("Crystalising", 81, 90, new Pair<>(112, 124), new Pair<>(168, 189), "", "")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "ColdDamage",
        ...
        LIGHTNING_DAMAGE_FLAT = new Modifier(
            ...
            List.of(
                new ModifierTier("Humming", 1, 1100, new Pair<>(1, 1), new Pair<>(7, 10), "", ""),
                new ModifierTier("Buzzing", 8, 1100, new Pair<>(1, 2), new Pair<>(19, 27), "", ""),
                new ModifierTier("Snapping", 16, 1100, new Pair<>(1, 3), new Pair<>(31, 43), "", ""),
                new ModifierTier("Crackling", 33, 1100, new Pair<>(1, 4), new Pair<>(53, 76), "", ""),
                new ModifierTier("Sparking", 46, 1100, new Pair<>(1, 4), new Pair<>(80, 88), "", ""),
                new ModifierTier("Arcing", 54, 1100, new Pair<>(1, 6), new Pair<>(93, 122), "", ""),
                new ModifierTier("Shocking", 60, 660, new Pair<>(1, 8), new Pair<>(128, 162), "", ""),
                new ModifierTier("Discharging", 65, 440, new Pair<>(1, 13), new Pair<>(168, 231), "", ""),
                new ModifierTier("Electrocuting", 75, 275, new Pair<>(1, 16), new Pair<>(239, 300), "", ""),
                new ModifierTier("Vapourising", 81, 110, new Pair<>(1, 19), new Pair<>(310, 358), "", "")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "LightningDamage",
...
//SUFFIXES
        ...
        INTELLIGENCE = new Modifier(
            ...
            List.of("attribute"),
            List.of(
                new ModifierTier("of the Pupil", 1, 250, new Pair<>(5, 8)),
                new ModifierTier("of the Student", 11, 250, new Pair<>(9, 12)),
                new ModifierTier("of the Prodigy", 22, 250, new Pair<>(13, 16)),
                new ModifierTier("of the Augur", 33, 250, new Pair<>(17, 20)),
                new ModifierTier("of the Philosopher", 44, 250, new Pair<>(21, 24)),
                new ModifierTier("of the Sage", 55, 250, new Pair<>(25, 27)),
                new ModifierTier("of the Savant", 66, 250, new Pair<>(28, 30)),
                new ModifierTier("of the Virtuoso", 74, 250, new Pair<>(31, 33))
            ),
            ModifierType.SUFFIX,
            ModifierSource.NORMAL,
            "Intelligence",
        ...
        LEVEL_MELEE_SKILL = new Modifier(
            ...
            List.of("attack"),
            List.of(
                new ModifierTier("of Combat", 2, 1000, new Pair<>(2, 2)),
                new ModifierTier("of Dueling", 18, 750, new Pair<>(3, 3)),
                new ModifierTier("of Conflict", 36, 500, new Pair<>(4, 4)),
                new ModifierTier("of Battle", 55, 250, new Pair<>(5, 6)),
                new ModifierTier("of War", 81, 100, new Pair<>(7, 7))
            ),
            ModifierType.SUFFIX,
            ModifierSource.NORMAL,
