package main.java.core.Item_modifiers.OneHand_Item_modifiers.Sceptres_Item_modifiers;
...
// PREFIXES
        ...
        HYBRID_INCREASED_SPIRIT_MANA = new Modifier(
            ...
            List.of(),
            List.of(
                new ModifierTier("Advisor's", 2, 1000, new Pair<>(10, 14), new Pair<>(17, 20), "increased_spirit", "maximum_mana"),
                new ModifierTier("Counselor's", 11, 1000, new Pair<>(15, 18), new Pair<>(21, 24), "increased_spirit", "maximum_mana"),
                new ModifierTier("Emissary's", 26, 1000, new Pair<>(19, 22), new Pair<>(25, 28), "increased_spirit", "maximum_mana"),
                new ModifierTier("Minister's", 36, 600, new Pair<>(23, 26), new Pair<>(29, 33), "increased_spirit", "maximum_mana"),
                new ModifierTier("Envoy's", 48, 400, new Pair<>(27, 30), new Pair<>(34, 37), "increased_spirit", "maximum_mana"),
                new ModifierTier("Diplomat's", 58, 200, new Pair<>(31, 34), new Pair<>(38, 41), "increased_spirit", "maximum_mana"),
                new ModifierTier("Chancellor's", 70, 100, new Pair<>(35, 38), new Pair<>(42, 45), "increased_spirit", "maximum_mana")
            ),
            ModifierType.PREFIX,
            ModifierSource.NORMAL,
