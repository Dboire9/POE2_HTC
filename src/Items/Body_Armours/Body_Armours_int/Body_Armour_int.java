package Items.Body_Armours.Body_Armours_int;


import java.util.ArrayList;

import Item_modifiers.Body_Armours_Item_modifiers.Body_Armours_Normal_Item_modifiers.*;


public class Body_Armour_int extends Body_Armour_int_Item {

    public Body_Armour_int() {
        ...
        Normal_allowedPrefixes.add(Modifiers_normal.HYBRID_BASE_AND_PERCENT_ENERGY_SHIELD);
