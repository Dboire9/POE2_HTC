...
describe('every string the panel quotes is still on screen somewhere', () => {
  ...
  const RENDERED_IN: Record<(typeof QUOTED_UI)[number], { file: string; find?: string }> = {
    ...
    'Item level': { file: 'features/engine/LabSetup.tsx' },
    'Rarity': { file: 'features/engine/YourItemCard.tsx' },
    'Find plans': { file: 'features/engine/LabSetup.tsx' },
    'Compute plan': { file: 'features/engine/ItemFullPlan.tsx' },
    ...
    'True expected cost': { file: 'features/engine/TrueCostCard.tsx' },
