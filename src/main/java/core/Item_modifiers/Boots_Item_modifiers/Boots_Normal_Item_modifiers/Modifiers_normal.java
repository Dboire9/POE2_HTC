package main.java.core.Item_modifiers.Boots_Item_modifiers.Boots_Normal_Item_modifiers;
...
// PREFIXES
        ...
        HYBRID_INCREASED_PERCENT_EVASION_AND_STUN = new Modifier(
            ...
            List.of("defences"),
            List.of(
                new ModifierTier("Mosquito's", 10, 1000, new Pair<>(6, 13), new Pair<>(8, 13), "increased_percent_evasion", "base_stun_threshold"),
                new ModifierTier("Moth's", 19, 1000, new Pair<>(14, 20), new Pair<>(14, 24), "increased_percent_evasion", "base_stun_threshold"),
                new ModifierTier("Butterfly's", 38, 1000, new Pair<>(21, 26), new Pair<>(25, 40), "increased_percent_evasion", "base_stun_threshold"),
                new ModifierTier("Wasp's", 48, 1000, new Pair<>(27, 32), new Pair<>(41, 63), "increased_percent_evasion", "base_stun_threshold"),
                new ModifierTier("Dragonfly's", 63, 1000, new Pair<>(33, 38), new Pair<>(64, 94), "increased_percent_evasion", "base_stun_threshold"),
                new ModifierTier("Hummingbird's", 74, 1000, new Pair<>(39, 42), new Pair<>(95, 136), "increased_percent_evasion", "base_stun_threshold")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "DefencesPercentAndStunThreshold",
        ...
        HYBRID_INCREASED_PERCENT_ENERGY_SHIELD_AND_STUN = new Modifier(
            ...
            List.of("defences"),
            List.of(
                new ModifierTier("Pixie's", 10, 1000, new Pair<>(6, 13), new Pair<>(8, 13), "increased_percent_energy_shield", "base_stun_threshold"),
                new ModifierTier("Gremlin's", 19, 1000, new Pair<>(14, 20), new Pair<>(14, 24), "increased_percent_energy_shield", "base_stun_threshold"),
                new ModifierTier("Boggart's", 38, 1000, new Pair<>(21, 26), new Pair<>(25, 40), "increased_percent_energy_shield", "base_stun_threshold"),
                new ModifierTier("Naga's", 48, 1000, new Pair<>(27, 32), new Pair<>(41, 63), "increased_percent_energy_shield", "base_stun_threshold"),
                new ModifierTier("Djinn's", 63, 1000, new Pair<>(33, 38), new Pair<>(64, 94), "increased_percent_energy_shield", "base_stun_threshold"),
                new ModifierTier("Seraphim's", 74, 1000, new Pair<>(39, 42), new Pair<>(95, 136), "increased_percent_energy_shield", "base_stun_threshold")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "DefencesPercentAndStunThreshold",
