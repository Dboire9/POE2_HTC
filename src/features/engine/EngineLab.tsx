  ...
  return (
    <div className="space-y-4">
      ...
      <div className="inline-flex rounded-md border border-border bg-muted/40 p-0.5 text-sm">
        ...
        >
          Streamer gear
          {/* Marked BETA because it ships unfinished, on purpose: a few streamers, a weekly
              snapshot (refresh-streamers.yml), and reads that are approximate in named places (Sanctified rolls). The
