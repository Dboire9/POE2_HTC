package core.Items.Body_Armours.Body_Armours_str_dex;
...
public class Body_Armours_str_dex extends Item_base {

    public Body_Armours_str_dex() {
        ...
        Normal_allowedPrefixes.add(Modifiers_normal.HYBRID_BASE_AND_PERCENT_ARMOUR_EVASION);
