...
public class Helmets_str_dex extends Item_base {
    ...
    public Helmets_str_dex() {
        ...
        Normal_allowedPrefixes.add(Modifiers_normal.BASE_ARMOUR_EVASION);
        Normal_allowedPrefixes.add(Modifiers_normal.INCREASED_PERCENT_ARMOUR_EVASION);
        Normal_allowedPrefixes.add(Modifiers_normal.HYBRID_INCREASED_PERCENT_ARMOUR_EVASION_AND_LIFE);
        Normal_allowedPrefixes.add(Modifiers_normal.HYBRID_INCREASED_PERCENT_ARMOUR_EVASION_AND_MANA);
        ...
        Desecrated_allowedSuffixes.add(Modifiers_desecrated.DESECRATED_GLORY_GENERATION);
