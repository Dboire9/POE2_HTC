package core.Items.Body_Armours.Body_Armours_dex_int;


import java.util.ArrayList;

import core.Item_modifiers.Body_Armours_Item_modifiers.Body_Armours_Hybrid_Item_modifiers.*;
import core.Items.*;

public class Body_Armours_dex_int extends Item_base {

    public Body_Armours_dex_int() {
        ...
        Normal_allowedPrefixes.add(Modifiers_normal.HYBRID_INCREASED_PERCENT_EVASION_ENERGY_SHIELD_LIFE);
        Normal_allowedPrefixes.add(Modifiers_normal.HYBRID_BASE_AND_PERCENT_EVASION_ENERGY_SHIELD);
        ...
        Desecrated_allowedPrefixes.add(Modifiers_desecrated.DESECRATED_COMPANION_RESERVATION_EFFICIENCY);
        Desecrated_allowedPrefixes.add(Modifiers_desecrated.DESECRATED_PREVENT_DEFLECT_DAMAGE_TAKEN);
