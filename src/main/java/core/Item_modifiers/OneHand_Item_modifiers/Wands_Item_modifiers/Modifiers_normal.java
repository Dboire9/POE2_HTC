package core.Item_modifiers.OneHand_Item_modifiers.Wands_Item_modifiers;
...
public class Modifiers_normal {
	...
	static {
		...
		HYBRID_INCREASED_SPELL_DAMAGE_AND_MAXIMUM_MANA = new Modifier(
				...
				List.of(
						new ModifierTier("Caster's", 2, 1000, new Pair<>(15, 19), new Pair<>(17, 20),
								"increased_spell_damage", "maximum_mana"),
						new ModifierTier("Conjuror's", 11, 1000, new Pair<>(20, 24), new Pair<>(21, 24),
								"increased_spell_damage", "maximum_mana"),
						new ModifierTier("Wizard's", 23, 1000, new Pair<>(25, 29), new Pair<>(25, 28),
								"increased_spell_damage", "maximum_mana"),
						new ModifierTier("Warlock's", 38, 600, new Pair<>(30, 34), new Pair<>(29, 33),
								"increased_spell_damage", "maximum_mana"),
						new ModifierTier("Mage's", 46, 400, new Pair<>(35, 39), new Pair<>(34, 37),
								"increased_spell_damage", "maximum_mana"),
						new ModifierTier("Archmage's", 60, 200, new Pair<>(40, 44), new Pair<>(38, 41),
								"increased_spell_damage", "maximum_mana"),
						new ModifierTier("Lich's", 80, 100, new Pair<>(45, 49), new Pair<>(42, 45),
								"increased_spell_damage", "maximum_mana")),
				ModifierType.PREFIX,
				ModifierSource.NORMAL,
				"SpellDamageAndMana",
