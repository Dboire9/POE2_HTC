package main.java.core.Item_modifiers.Body_Armours_Item_modifiers.Body_Armours_Hybrid_Item_modifiers;
...
// PREFIXES
        ...
        HYBRID_BASE_ARMOUR_EVASION = new Modifier(
            ...
            List.of(
                ...
                new ModifierTier("Resilient", 60, 1000, new Pair<>(79, 98), new Pair<>(70, 88), "base_armour", "base_evasion"),
                new ModifierTier("Adaptable", 65, 1000, new Pair<>(99, 117), new Pair<>(89, 107), "base_armour", "base_evasion"),
                new ModifierTier("Versatile", 75, 1000, new Pair<>(118, 138), new Pair<>(108, 126), "base_armour", "base_evasion")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "BaseLocalDefences",
        ...
        HYBRID_BASE_ARMOUR_ENERGY_SHIELD = new Modifier(
            ...
            List.of(
                ...
                new ModifierTier("Consecrated", 60, 1000, new Pair<>(79, 98), new Pair<>(30, 36), "base_armour", "base_energy_shield"),
                new ModifierTier("Saintly", 65, 1000, new Pair<>(99, 117), new Pair<>(37, 42), "base_armour", "base_energy_shield"),
                new ModifierTier("Godly", 75, 1000, new Pair<>(118, 138), new Pair<>(43, 48), "base_armour", "base_energy_shield")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "BaseLocalDefences",
        ...
        HYBRID_BASE_EVASION_ENERGY_SHIELD = new Modifier(
            ...
            List.of(
                ...
                new ModifierTier("Eidolon's", 60, 1000, new Pair<>(70, 88), new Pair<>(30, 36), "base_evasion", "base_energy_shield"),
                new ModifierTier("Apparition's", 65, 1000, new Pair<>(89, 107), new Pair<>(37, 42), "base_evasion", "base_energy_shield"),
                new ModifierTier("Banshee's", 75, 1000, new Pair<>(108, 126), new Pair<>(43, 48), "base_evasion", "base_energy_shield")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "BaseLocalDefences",
        ...
        HYBRID_INCREASED_PERCENT_ARMOUR_EVASION = new Modifier(
            ...
            List.of(
                ...
                new ModifierTier("Victor's", 75, 1000, new Pair<>(101, 110), new Pair<>(101, 110), "increased_percent_armour", "increased_percent_evasion")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "DefencesPercent",
        ...
        HYBRID_INCREASED_PERCENT_ARMOUR_ENERGY_SHIELD = new Modifier(
            ...
            List.of(
                ...
                new ModifierTier("Interpermeated", 75, 1000, new Pair<>(101, 110), new Pair<>(101, 110), "increased_percent_armour", "increased_percent_energy_shield")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "DefencesPercent",
        ...
        HYBRID_INCREASED_PERCENT_EVASION_ENERGY_SHIELD = new Modifier(
            ...
            List.of(
                ...
                new ModifierTier("Incorporeal", 75, 1000, new Pair<>(101, 110), new Pair<>(101, 110), "increased_percent_evasion", "increased_percent_energy_shield")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "DefencesPercent",
        ...
        HYBRID_BASE_AND_PERCENT_ARMOUR_EVASION = new Modifier(
            ...
            List.of("defences"),
            List.of(
                new ModifierTier("Swordsman's", 8, 1000, new Pair<>(4, 6), new Pair<>(3, 5), new Pair<>(6, 13), new Pair<>(6, 13),"base_armour", "base_evasion","increased_percent_armour", "increased_percent_evasion"),
                new ModifierTier("Fighter's", 16, 1000, new Pair<>(7, 15), new Pair<>(6, 12), new Pair<>(14, 20), new Pair<>(14, 20),"base_armour", "base_evasion","increased_percent_armour", "increased_percent_evasion"),
                new ModifierTier("Veteran's", 33, 1000, new Pair<>(16, 20), new Pair<>(13, 17), new Pair<>(21, 26), new Pair<>(21, 26),"base_armour", "base_evasion","increased_percent_armour", "increased_percent_evasion"),
                new ModifierTier("Warrior's", 46, 1000, new Pair<>(21, 27), new Pair<>(18, 24), new Pair<>(27, 32), new Pair<>(27, 32),"base_armour", "base_evasion","increased_percent_armour", "increased_percent_evasion"),
                new ModifierTier("Knight's", 60, 1000, new Pair<>(28, 34), new Pair<>(25, 31), new Pair<>(33, 38), new Pair<>(33, 38),"base_armour", "base_evasion","increased_percent_armour", "increased_percent_evasion"),
                new ModifierTier("Centurion's", 78, 1000, new Pair<>(35, 43), new Pair<>(32, 39), new Pair<>(39, 42), new Pair<>(39, 42),"base_armour", "base_evasion","increased_percent_armour", "increased_percent_evasion")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
        ...
        HYBRID_BASE_AND_PERCENT_ARMOUR_ENERGY_SHIELD = new Modifier(
            ...
            List.of("defences"),
            List.of(
                new ModifierTier("Faithful", 8, 1000, new Pair<>(4, 6), new Pair<>(2, 4), new Pair<>(6, 13), new Pair<>(6, 13), "base_armour", "base_energy_shield", "increased_percent_armour", "increased_percent_energy_shield"),
                new ModifierTier("Noble's", 16, 1000, new Pair<>(7, 15), new Pair<>(5, 6), new Pair<>(14, 20), new Pair<>(14, 20), "base_armour", "base_energy_shield", "increased_percent_armour", "increased_percent_energy_shield"),
                new ModifierTier("Inquisitor's", 33, 1000, new Pair<>(16, 20), new Pair<>(7, 8), new Pair<>(21, 26), new Pair<>(21, 26), "base_armour", "base_energy_shield", "increased_percent_armour", "increased_percent_energy_shield"),
                new ModifierTier("Crusader's", 46, 1000, new Pair<>(21, 27), new Pair<>(9, 10), new Pair<>(27, 32), new Pair<>(27, 32), "base_armour", "base_energy_shield", "increased_percent_armour", "increased_percent_energy_shield"),
                new ModifierTier("Paladin's", 60, 1000, new Pair<>(28, 34), new Pair<>(11, 12), new Pair<>(33, 38), new Pair<>(33, 38), "base_armour", "base_energy_shield", "increased_percent_armour", "increased_percent_energy_shield"),
                new ModifierTier("Grand", 78, 1000, new Pair<>(35, 43), new Pair<>(13, 15), new Pair<>(39, 42), new Pair<>(39, 42), "base_armour", "base_energy_shield", "increased_percent_armour", "increased_percent_energy_shield")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "BaseLocalDefencesAndDefencePercent",
        ...
        HYBRID_BASE_AND_PERCENT_EVASION_ENERGY_SHIELD = new Modifier(
            ...
            List.of("defences"),
            List.of(
                new ModifierTier("Pursuer's", 8, 1000, new Pair<>(3, 5), new Pair<>(2, 4), new Pair<>(6, 13), new Pair<>(6, 13), "base_evasion", "base_energy_shield", "increased_percent_evasion", "increased_percent_energy_shield"),
                new ModifierTier("Tracker's", 16, 1000, new Pair<>(6, 12), new Pair<>(5, 6), new Pair<>(14, 20), new Pair<>(14, 20), "base_evasion", "base_energy_shield", "increased_percent_evasion", "increased_percent_energy_shield"),
                new ModifierTier("Chaser's", 33, 1000, new Pair<>(13, 17), new Pair<>(7, 8), new Pair<>(21, 26), new Pair<>(21, 26), "base_evasion", "base_energy_shield", "increased_percent_evasion", "increased_percent_energy_shield"),
                new ModifierTier("Phantom's", 46, 1000, new Pair<>(18, 24), new Pair<>(9, 10), new Pair<>(27, 32), new Pair<>(27, 32), "base_evasion", "base_energy_shield", "increased_percent_evasion", "increased_percent_energy_shield"),
                new ModifierTier("Rogue's", 60, 1000, new Pair<>(25, 31), new Pair<>(11, 12), new Pair<>(33, 38), new Pair<>(33, 38), "base_evasion", "base_energy_shield", "increased_percent_evasion", "increased_percent_energy_shield"),
                new ModifierTier("Stalker's", 78, 1000, new Pair<>(32, 39), new Pair<>(13, 15), new Pair<>(39, 42), new Pair<>(39, 42), "base_evasion", "base_energy_shield", "increased_percent_evasion", "increased_percent_energy_shield")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "BaseLocalDefencesAndDefencePercent",
