...
public class Modifiers_normal {
	...
	static {
		...
		ALL_ATTRIBUTES = new Modifier(
				...
				List.of("attribute"),
				List.of(
						new ModifierTier("of the Clouds", 1, 800, new Pair<>(2, 4), new Pair<>(2, 4), new Pair<>(2, 4),
								"strength", "dexterity", "intelligence"),
						new ModifierTier("of the Sky", 11, 800, new Pair<>(5, 7), new Pair<>(5, 7), new Pair<>(5, 7),
								"strength", "dexterity", "intelligence"),
						new ModifierTier("of the Meteor", 22, 800, new Pair<>(8, 10), new Pair<>(8, 10),
								new Pair<>(8, 10), "strength", "dexterity", "intelligence"),
						new ModifierTier("of the Comet", 33, 800, new Pair<>(11, 13), new Pair<>(11, 13),
								new Pair<>(11, 13), "strength", "dexterity", "intelligence"),
						new ModifierTier("of the Heavens", 44, 800, new Pair<>(14, 16), new Pair<>(14, 16),
								new Pair<>(14, 16), "strength", "dexterity", "intelligence"),
						new ModifierTier("of the Galaxy", 55, 800, new Pair<>(17, 18), new Pair<>(17, 18),
								new Pair<>(17, 18), "strength", "dexterity", "intelligence"),
						new ModifierTier("of the Universe", 66, 800, new Pair<>(19, 20), new Pair<>(19, 20),
								new Pair<>(19, 20), "strength", "dexterity", "intelligence"),
						new ModifierTier("of the Multiverse", 75, 800, new Pair<>(21, 22), new Pair<>(21, 22),
								new Pair<>(21, 22), "strength", "dexterity", "intelligence"),
						new ModifierTier("of the Infinite", 82, 800, new Pair<>(23, 24), new Pair<>(23, 24),
								new Pair<>(23, 24), "strength", "dexterity", "intelligence")),
				Modifier.ModifierType.SUFFIX,
				Modifier.ModifierSource.NORMAL,
				"AllAttributes",
				"+# to all Attributes");
		...
		ALL_RESISTANCES = new Modifier(
				...
				List.of(
						...
						new ModifierTier("of the Span", 80, 800, new Pair<>(17, 18), new Pair<>(17, 18),
								new Pair<>(17, 18), "fire_resistance", "cold_resistance", "lightning_resistance")),
				Modifier.ModifierType.SUFFIX,
				Modifier.ModifierSource.NORMAL,
				"AllResistances",
