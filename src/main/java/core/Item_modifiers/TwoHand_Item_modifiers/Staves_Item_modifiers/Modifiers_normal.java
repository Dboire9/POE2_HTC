package main.java.core.Item_modifiers.TwoHand_Item_modifiers.Staves_Item_modifiers;
...
// PREFIXES
        ...
        HYBRID_INCREASED_SPELL_DAMAGE_AND_MAXIMUM_MANA = new Modifier(
            ...
            List.of(
                new ModifierTier("Caster's", 2, 1000, new Pair<>(21, 27), new Pair<>(26, 30), "increased_spell_damage", "maximum_mana"),
                new ModifierTier("Conjuror's", 11, 1000, new Pair<>(28, 34), new Pair<>(31, 35), "increased_spell_damage", "maximum_mana"),
                new ModifierTier("Wizard's", 23, 1000, new Pair<>(35, 41), new Pair<>(36, 41), "increased_spell_damage", "maximum_mana"),
                new ModifierTier("Warlock's", 38, 600, new Pair<>(42, 48), new Pair<>(42, 47), "increased_spell_damage", "maximum_mana"),
                new ModifierTier("Mage's", 48, 400, new Pair<>(49, 55), new Pair<>(48, 53), "increased_spell_damage", "maximum_mana"),
                new ModifierTier("Archmage's", 63, 200, new Pair<>(56, 63), new Pair<>(54, 59), "increased_spell_damage", "maximum_mana"),
                new ModifierTier("Lich's", 79, 100, new Pair<>(64, 69), new Pair<>(60, 64), "increased_spell_damage", "maximum_mana")
            ),
            ModifierType.PREFIX,
            ModifierSource.NORMAL,
            "SpellDamageAndMana",
