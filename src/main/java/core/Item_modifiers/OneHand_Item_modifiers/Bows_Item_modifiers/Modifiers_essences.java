...
public class Modifiers_essences {
    ...
    static {
        ...
        ESSENCE_PHYSICAL_DAMAGE_FLAT = new Modifier(
            ...
            List.of("physical", "damage", "attack"),
            List.of(
                new ModifierTier("Lesser Essence of Abrasion", 8, 1, new Pair<>(4, 6), new Pair<>(7, 11), "", ""),
                new ModifierTier("Essence of Abrasion", 46, 1, new Pair<>(10, 15), new Pair<>(18, 26), "", ""),
                new ModifierTier("Greater Essence of Abrasion", 60, 1, new Pair<>(16, 24), new Pair<>(28, 42), "", "")
            ),
            ModifierType.PREFIX,
        ...
        ESSENCE_FIRE_DAMAGE_FLAT = new Modifier(
            ...
            List.of(
                new ModifierTier("Lesser Essence of Flames", 8, 1, new Pair<>(4, 6), new Pair<>(7, 10), "", ""),
                new ModifierTier("Essence of Flames", 46, 1, new Pair<>(20, 24), new Pair<>(32, 37), "", ""),
                new ModifierTier("Greater Essence of Flames", 60, 1, new Pair<>(35, 44), new Pair<>(56, 71), "", "")
            ),
            ModifierType.PREFIX,
            ModifierSource.ESSENCE,
            "FireDamage",
        ...
        ESSENCE_COLD_DAMAGE_FLAT = new Modifier(
            ...
            List.of(
                new ModifierTier("Lesser Essence of Ice", 8, 1, new Pair<>(3, 5), new Pair<>(6, 9), "", ""),
                new ModifierTier("Essence of Ice", 46, 1, new Pair<>(17, 20), new Pair<>(26, 32), "", ""),
                new ModifierTier("Greater Essence of Ice", 60, 1, new Pair<>(31, 38), new Pair<>(47, 59), "", "")
            ),
            ModifierType.PREFIX,
            ModifierSource.ESSENCE,
            "ColdDamage",
        ...
        ESSENCE_LIGHTNING_DAMAGE_FLAT = new Modifier(
            ...
            List.of(
                new ModifierTier("Lesser Essence of Electricity", 8, 1, new Pair<>(1, 1), new Pair<>(13, 19), "", ""),
                new ModifierTier("Essence of Electricity", 46, 1, new Pair<>(1, 3), new Pair<>(55, 60), "", ""),
                new ModifierTier("Greater Essence of Electricity", 60, 1, new Pair<>(1, 6), new Pair<>(85, 107), "", "")
            ),
            ModifierType.PREFIX,
            ModifierSource.ESSENCE,
            "LightningDamage",
