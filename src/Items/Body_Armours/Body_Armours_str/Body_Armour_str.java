package Items.Body_Armours.Body_Armours_str;
...
public class Body_Armour_str extends Body_Armour_str_Item {

    public Body_Armour_str() {
        ...
        Normal_allowedPrefixes.add(Modifiers_normal.HYBRID_BASE_AND_PERCENT_ARMOUR);
