package core.Item_modifiers.Boots_Item_modifiers.Boots_Hybrid_Item_modifiers;
...
public class Modifiers_normal {
	...
	static {
		...
		HYBRID_INCREASED_PERCENT_EVASION_ENERGY_SHIELD_AND_STUN = new Modifier(
				...
				List.of("defences"),
				List.of(
						new ModifierTier("Intuitive", 10, 1000, new Pair<>(6, 13), new Pair<>(6, 13), new Pair<>(8, 13),
								"increased_percent_evasion", "increased_percent_energy_shield", "base_stun_threshold"),
						new ModifierTier("Psychic", 19, 1000, new Pair<>(14, 20), new Pair<>(14, 20),
								new Pair<>(14, 24), "increased_percent_evasion", "increased_percent_energy_shield",
								"base_stun_threshold"),
						new ModifierTier("Telepath's", 38, 1000, new Pair<>(21, 26), new Pair<>(21, 26),
								new Pair<>(25, 40), "increased_percent_evasion", "increased_percent_energy_shield",
								"base_stun_threshold"),
						new ModifierTier("Illusionist's", 48, 1000, new Pair<>(27, 32), new Pair<>(27, 32),
								new Pair<>(41, 63), "increased_percent_evasion", "increased_percent_energy_shield",
								"base_stun_threshold"),
						new ModifierTier("Mentalist's", 63, 1000, new Pair<>(33, 38), new Pair<>(33, 38),
								new Pair<>(64, 94), "increased_percent_evasion", "increased_percent_energy_shield",
								"base_stun_threshold"),
						new ModifierTier("Trickster's", 74, 1000, new Pair<>(39, 42), new Pair<>(39, 42),
								new Pair<>(95, 136), "increased_percent_evasion", "increased_percent_energy_shield",
								"base_stun_threshold")),
				Modifier.ModifierType.PREFIX,
				Modifier.ModifierSource.NORMAL,
				"DefencesPercentAndStunThreshold",
