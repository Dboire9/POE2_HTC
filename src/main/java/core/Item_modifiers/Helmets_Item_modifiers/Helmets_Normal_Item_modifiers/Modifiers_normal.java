...
public class Modifiers_normal {
	...
	static {
		...
		HYBRID_INCREASED_PERCENT_ARMOUR_AND_MANA = new Modifier(
				...
				List.of(
						new ModifierTier("Imposing", 8, 1000, new Pair<>(6, 13), new Pair<>(6, 8),
								"increased_percent_armour", "base_maximum_mana"),
						new ModifierTier("Venerable", 16, 1000, new Pair<>(14, 20), new Pair<>(9, 16),
								"increased_percent_armour", "base_maximum_mana"),
						new ModifierTier("Regal", 33, 1000, new Pair<>(21, 26), new Pair<>(17, 20),
								"increased_percent_armour", "base_maximum_mana"),
						new ModifierTier("Colossal", 46, 1000, new Pair<>(27, 32), new Pair<>(21, 26),
								"increased_percent_armour", "base_maximum_mana"),
						new ModifierTier("Chieftain's", 60, 1000, new Pair<>(33, 38), new Pair<>(27, 32),
								"increased_percent_armour", "base_maximum_mana"),
						new ModifierTier("Ancestral", 78, 1000, new Pair<>(39, 42), new Pair<>(33, 39),
								"increased_percent_armour", "base_maximum_mana")),
				Modifier.ModifierType.PREFIX,
				Modifier.ModifierSource.NORMAL,
		...
		HYBRID_INCREASED_PERCENT_EVASION_AND_MANA = new Modifier(
				...
				List.of("defences", "mana"),
				List.of(
						new ModifierTier("Nomad's", 8, 1000, new Pair<>(6, 13), new Pair<>(6, 8),
								"increased_percent_evasion", "base_maximum_mana"),
						new ModifierTier("Drifter's", 16, 1000, new Pair<>(14, 20), new Pair<>(9, 16),
								"increased_percent_evasion", "base_maximum_mana"),
						new ModifierTier("Traveller's", 33, 1000, new Pair<>(21, 26), new Pair<>(17, 20),
								"increased_percent_evasion", "base_maximum_mana"),
						new ModifierTier("Explorer's", 46, 1000, new Pair<>(27, 32), new Pair<>(21, 26),
								"increased_percent_evasion", "base_maximum_mana"),
						new ModifierTier("Wayfarer's", 60, 1000, new Pair<>(33, 38), new Pair<>(27, 32),
								"increased_percent_evasion", "base_maximum_mana"),
						new ModifierTier("Wanderer's", 78, 1000, new Pair<>(39, 42), new Pair<>(33, 39),
								"increased_percent_evasion", "base_maximum_mana")),
				Modifier.ModifierType.PREFIX,
				Modifier.ModifierSource.NORMAL,
				"BaseLocalDefencesAndMana",
		...
		HYBRID_INCREASED_PERCENT_ENERGY_SHIELD_AND_MANA = new Modifier(
				...
				List.of("defences", "mana"),
				List.of(
						new ModifierTier("Imbued", 8, 1000, new Pair<>(6, 13), new Pair<>(6, 8),
								"increased_percent_energy_shield", "base_maximum_mana"),
						new ModifierTier("Serene", 16, 1000, new Pair<>(14, 20), new Pair<>(9, 16),
								"increased_percent_energy_shield", "base_maximum_mana"),
						new ModifierTier("Sacred", 33, 1000, new Pair<>(21, 26), new Pair<>(17, 20),
								"increased_percent_energy_shield", "base_maximum_mana"),
						new ModifierTier("Celestial", 46, 1000, new Pair<>(27, 32), new Pair<>(21, 26),
								"increased_percent_energy_shield", "base_maximum_mana"),
						new ModifierTier("Heavenly", 60, 1000, new Pair<>(33, 38), new Pair<>(27, 32),
								"increased_percent_energy_shield", "base_maximum_mana"),
						new ModifierTier("Angel's", 78, 1000, new Pair<>(39, 42), new Pair<>(33, 39),
								"increased_percent_energy_shield", "base_maximum_mana")),
				Modifier.ModifierType.PREFIX,
				Modifier.ModifierSource.NORMAL,
				"BaseLocalDefencesAndMana",
