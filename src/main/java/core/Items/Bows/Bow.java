package main.java.core.Items.Bows;


import main.java.core.Item_modifiers.OneHand_Item_modifiers.Bows_Item_modifiers.*;

import java.util.ArrayList;


public class Bow extends Bow_Item {
    ...
    public Bow() {
        ...
        Normal_allowedSuffixes.add(Modifiers_normal.ADDITIONAL_ARROWS);

        Desecrated_allowedPrefixes = new ArrayList<>();
        Desecrated_allowedPrefixes.add(Modifiers_desecrated.DESECRATED_INCREASED_ATTACK_AREA_OF_EFFECT);
        Desecrated_allowedPrefixes.add(Modifiers_desecrated.DESECRATED_COMPANION_DAMAGE);
        Desecrated_allowedPrefixes.add(Modifiers_desecrated.DESECRATED_FIRE_PENETRATION);
        Desecrated_allowedPrefixes.add(Modifiers_desecrated.DESECRATED_CHAIN_FROM_TERRAIN);
        Desecrated_allowedPrefixes.add(Modifiers_desecrated.DESECRATED_QUIVER_BONUS);
        ...
        Desecrated_allowedSuffixes.add(Modifiers_desecrated.DESECRATED_CHANCE_TO_PIERCE);
        Desecrated_allowedSuffixes.add(Modifiers_desecrated.DESECRATED_COMPANION_ATTACK_SPEED);
        Desecrated_allowedSuffixes.add(Modifiers_desecrated.DESECRATED_SPIRIT_RESERVATION_EFFICIENCY);
        Desecrated_allowedSuffixes.add(Modifiers_desecrated.DESECRATED_IMMOBILISATION_BUILDUP);
