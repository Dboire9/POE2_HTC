package core.Items.Boots.Boots_dex_int;
...
public class Boots_dex_int extends Item_base {

    public Boots_dex_int() {
        ...
        Normal_allowedPrefixes.add(Modifiers_normal.HYBRID_BASE_EVASION_ENERGY_SHIELD);
        Normal_allowedPrefixes.add(Modifiers_normal.HYBRID_INCREASED_PERCENT_EVASION_ENERGY_SHIELD);
        Normal_allowedPrefixes.add(Modifiers_normal.HYBRID_INCREASED_PERCENT_EVASION_ENERGY_SHIELD_AND_STUN);
        ...
        Desecrated_allowedSuffixes.add(Modifiers_desecrated.DESECRATED_DODGE_ROLL_DISTANCE);
        Desecrated_allowedSuffixes.add(Modifiers_desecrated.DESECRATED_SLOW_POTENCY_REDUCTION);
        Desecrated_allowedSuffixes.add(Modifiers_desecrated.DESECRATED_REDUCED_SELF_IGNITE_DURATION);
        ...
        Desecrated_allowedSuffixes.add(Modifiers_desecrated.DESECRATED_REDUCED_BLEEDING_DURATION);
        Desecrated_allowedSuffixes.add(Modifiers_desecrated.DESECRATED_REDUCED_POISON_DURATION);
        Desecrated_allowedSuffixes.add(Modifiers_desecrated.DESECRATED_MANA_COST_EFFICIENCY_IF_DODGE_ROLL);
        Desecrated_allowedSuffixes.add(Modifiers_desecrated.DESECRATED_MANA_REGENERATION_WHILE_STATIONARY);
        ...
        Essences_allowedPrefixes.add(Modifiers_essences.ESSENCE_HYBRID_INCREASED_PERCENT_EVASION_ENERGY_SHIELD);
