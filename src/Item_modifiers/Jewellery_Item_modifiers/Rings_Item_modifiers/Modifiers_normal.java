package Item_modifiers.Jewellery_Item_modifiers.Rings_Item_modifiers;
...
// SUFFIXES
        ...
        ALL_ATTRIBUTES = new Modifier(
            ...
            List.of("attribute"),
            List.of(
                new ModifierTier("of the Clouds", 1, 400, new Pair<>(2, 4), new Pair<>(2, 4), new Pair<>(2, 4), "strength", "dexterity", "intelligence"),
                new ModifierTier("of the Sky", 11, 400, new Pair<>(5, 7), new Pair<>(5, 7), new Pair<>(5, 7), "strength", "dexterity", "intelligence"),
                new ModifierTier("of the Meteor", 22, 400, new Pair<>(8, 10), new Pair<>(8, 10), new Pair<>(8, 10), "strength", "dexterity", "intelligence"),
                new ModifierTier("of the Comet", 33, 400, new Pair<>(11, 13), new Pair<>(11, 13), new Pair<>(11, 13), "strength", "dexterity", "intelligence")
            ),
            Modifier.ModifierType.SUFFIX,
            Modifier.ModifierSource.NORMAL,
            "AllAttributes",
