package main.java.core.Item_modifiers.TwoHand_Item_modifiers.TwoHandMaces_Items_modifiers;
...
// PREFIXES
        ...
        FIRE_DAMAGE_FLAT = new Modifier(
            ...
            List.of(
                new ModifierTier("Heated", 1, 1200, new Pair<>(2, 4), new Pair<>(5, 7), "", ""),
                new ModifierTier("Smouldering", 8, 1200, new Pair<>(6, 9), new Pair<>(10, 16), "", ""),
                new ModifierTier("Smoking", 16, 1200, new Pair<>(11, 17), new Pair<>(19, 28), "", ""),
                new ModifierTier("Burning", 33, 1200, new Pair<>(19, 27), new Pair<>(30, 42), "", ""),
                new ModifierTier("Flaming", 46, 1200, new Pair<>(30, 37), new Pair<>(45, 56), "", ""),
                new ModifierTier("Scorching", 54, 1200, new Pair<>(39, 53), new Pair<>(59, 80), "", ""),
                new ModifierTier("Incinerating", 60, 720, new Pair<>(56, 70), new Pair<>(84, 107), "", ""),
                new ModifierTier("Blasting", 65, 480, new Pair<>(73, 97), new Pair<>(112, 149), "", ""),
                new ModifierTier("Cremating", 75, 300, new Pair<>(102, 130), new Pair<>(155, 198), "", ""),
                new ModifierTier("Carbonising", 81, 120, new Pair<>(135, 156), new Pair<>(205, 236), "", "")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "FireDamage",
        ...
        LIGHTNING_DAMAGE_FLAT = new Modifier(
            ...
            List.of(
                new ModifierTier("Humming", 1, 800, new Pair<>(1, 1), new Pair<>(7, 10), "", ""),
                new ModifierTier("Buzzing", 8, 800, new Pair<>(1, 2), new Pair<>(19, 27), "", ""),
                new ModifierTier("Snapping", 16, 800, new Pair<>(1, 3), new Pair<>(31, 43), "", ""),
                new ModifierTier("Crackling", 33, 800, new Pair<>(1, 4), new Pair<>(53, 76), "", ""),
                new ModifierTier("Sparking", 46, 800, new Pair<>(1, 4), new Pair<>(80, 88), "", ""),
                new ModifierTier("Arcing", 54, 800, new Pair<>(1, 6), new Pair<>(93, 122), "", ""),
                new ModifierTier("Shocking", 60, 480, new Pair<>(1, 8), new Pair<>(128, 162), "", ""),
                new ModifierTier("Discharging", 65, 320, new Pair<>(1, 13), new Pair<>(168, 231), "", ""),
                new ModifierTier("Electrocuting", 75, 200, new Pair<>(1, 16), new Pair<>(239, 300), "", ""),
                new ModifierTier("Vapourising", 81, 80, new Pair<>(1, 19), new Pair<>(310, 358), "", "")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "LightningDamage",
