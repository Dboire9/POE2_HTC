...
import Item_modifiers.Helmets_Item_modifiers.Helmets_Normal_Item_modifiers.*;


public class Helmet_dex extends Helmet_dex_Item {
    ...
    public Helmet_dex() {
        ...
        Normal_allowedPrefixes.add(Modifiers_normal.HYBRID_INCREASED_PERCENT_EVASION_AND_MANA);
