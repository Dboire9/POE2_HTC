package core.Items.Helmets.Helmets_dex_int;
...
public class Helmets_dex_int extends Item_base {

    public Helmets_dex_int() {
        ...
        Normal_allowedPrefixes.add(Modifiers_normal.BASE_EVASION_ENERGY_SHIELD);
        Normal_allowedPrefixes.add(Modifiers_normal.INCREASED_PERCENT_EVASION_ENERGY_SHIELD);
        Normal_allowedPrefixes.add(Modifiers_normal.HYBRID_INCREASED_PERCENT_EVASION_ENERGY_SHIELD_AND_LIFE);
        Normal_allowedPrefixes.add(Modifiers_normal.HYBRID_INCREASED_PERCENT_EVASION_ENERGY_SHIELD_AND_MANA);
        ...
        Desecrated_allowedSuffixes.add(Modifiers_desecrated.DESECRATED_MARK_DAMAGE);
