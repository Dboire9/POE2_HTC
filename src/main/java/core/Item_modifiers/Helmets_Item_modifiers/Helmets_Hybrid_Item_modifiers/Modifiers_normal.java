...
public class Modifiers_normal {
	...
	static {
		...
		HYBRID_INCREASED_PERCENT_ARMOUR_EVASION_AND_MANA = new Modifier(
				...
				List.of(
						new ModifierTier("Rhoa's", 8, 1000, new Pair<>(6, 13), new Pair<>(6, 13), new Pair<>(6, 8),
								"increased_percent_armour", "increased_percent_evasion", "base_maximum_mana"),
						new ModifierTier("Rhex's", 16, 1000, new Pair<>(14, 20), new Pair<>(14, 20), new Pair<>(9, 16),
								"increased_percent_armour", "increased_percent_evasion", "base_maximum_mana"),
						new ModifierTier("Chimeral's", 33, 1000, new Pair<>(21, 26), new Pair<>(21, 26),
								new Pair<>(17, 20), "increased_percent_armour", "increased_percent_evasion",
								"base_maximum_mana"),
						new ModifierTier("Bull's", 46, 1000, new Pair<>(27, 32), new Pair<>(27, 32), new Pair<>(21, 26),
								"increased_percent_armour", "increased_percent_evasion", "base_maximum_mana"),
						new ModifierTier("Minotaur's", 60, 1000, new Pair<>(33, 38), new Pair<>(33, 38),
								new Pair<>(27, 32), "increased_percent_armour", "increased_percent_evasion",
								"base_maximum_mana"),
						new ModifierTier("Cerberus'", 78, 1000, new Pair<>(39, 42), new Pair<>(39, 42),
								new Pair<>(33, 39), "increased_percent_armour", "increased_percent_evasion",
								"base_maximum_mana")),
				Modifier.ModifierType.PREFIX,
				Modifier.ModifierSource.NORMAL,
		...
		HYBRID_INCREASED_PERCENT_ARMOUR_ENERGY_SHIELD_AND_MANA = new Modifier(
				...
				List.of("defences", "mana"),
				List.of(
						new ModifierTier("Coelacanth's", 8, 1000, new Pair<>(6, 13), new Pair<>(6, 13),
								new Pair<>(6, 8), "increased_percent_armour", "increased_percent_energy_shield",
								"base_maximum_mana"),
						new ModifierTier("Swordfish's", 16, 1000, new Pair<>(14, 20), new Pair<>(14, 20),
								new Pair<>(9, 16), "increased_percent_armour", "increased_percent_energy_shield",
								"base_maximum_mana"),
						new ModifierTier("Shark's", 33, 1000, new Pair<>(21, 26), new Pair<>(21, 26),
								new Pair<>(17, 20), "increased_percent_armour", "increased_percent_energy_shield",
								"base_maximum_mana"),
						new ModifierTier("Dolphin's", 46, 1000, new Pair<>(27, 32), new Pair<>(27, 32),
								new Pair<>(21, 26), "increased_percent_armour", "increased_percent_energy_shield",
								"base_maximum_mana"),
						new ModifierTier("Orca's", 60, 1000, new Pair<>(33, 38), new Pair<>(33, 38), new Pair<>(27, 32),
								"increased_percent_armour", "increased_percent_energy_shield", "base_maximum_mana"),
						new ModifierTier("Whale's", 78, 1000, new Pair<>(39, 42), new Pair<>(39, 42),
								new Pair<>(33, 39), "increased_percent_armour", "increased_percent_energy_shield",
								"base_maximum_mana")),
				Modifier.ModifierType.PREFIX,
				Modifier.ModifierSource.NORMAL,
				"BaseLocalDefencesAndMana",
		...
		HYBRID_INCREASED_PERCENT_EVASION_ENERGY_SHIELD_AND_MANA = new Modifier(
				...
				List.of("defences", "mana"),
				List.of(
						new ModifierTier("Vulture's", 8, 1000, new Pair<>(6, 13), new Pair<>(6, 13), new Pair<>(6, 8),
								"increased_percent_evasion", "increased_percent_energy_shield", "base_maximum_mana"),
						new ModifierTier("Kingfisher's", 16, 1000, new Pair<>(14, 20), new Pair<>(14, 20),
								new Pair<>(9, 16), "increased_percent_evasion", "increased_percent_energy_shield",
								"base_maximum_mana"),
						new ModifierTier("Owl's", 33, 1000, new Pair<>(21, 26), new Pair<>(21, 26), new Pair<>(17, 20),
								"increased_percent_evasion", "increased_percent_energy_shield", "base_maximum_mana"),
						new ModifierTier("Hawk's", 46, 1000, new Pair<>(27, 32), new Pair<>(27, 32), new Pair<>(21, 26),
								"increased_percent_evasion", "increased_percent_energy_shield", "base_maximum_mana"),
						new ModifierTier("Eagle's", 60, 1000, new Pair<>(33, 38), new Pair<>(33, 38),
								new Pair<>(27, 32), "increased_percent_evasion", "increased_percent_energy_shield",
								"base_maximum_mana"),
						new ModifierTier("Falcon's", 78, 1000, new Pair<>(39, 42), new Pair<>(39, 42),
								new Pair<>(33, 39), "increased_percent_evasion", "increased_percent_energy_shield",
								"base_maximum_mana")),
				Modifier.ModifierType.PREFIX,
				Modifier.ModifierSource.NORMAL,
				"BaseLocalDefencesAndMana",
