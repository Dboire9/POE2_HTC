...
// *
// * This class tests the crafting optimization algorithm for items that already
...
// List<Modifier> possibleEssencesPrefixes =
// testItem.getEssencesAllowedPrefixes();
// List<Modifier> possibleEssencesSuffixes =
// testItem.getEssencesAllowedSuffixes();
// List<Modifier> possibleDesecratedPrefixes =
// testItem.getDesecratedAllowedPrefixes();
// List<Modifier> possibleDesecratedSuffixes =
// testItem.getDesecratedAllowedSuffixes();

// // Combine all prefixes and suffixes
// List<Modifier> allPrefixes = new ArrayList<>();
// if (possiblePrefixes != null)
// allPrefixes.addAll(possiblePrefixes);
// if (possibleEssencesPrefixes != null)
// allPrefixes.addAll(possibleEssencesPrefixes);
// if (possibleDesecratedPrefixes != null)
// allPrefixes.addAll(possibleDesecratedPrefixes);

// List<Modifier> allSuffixes = new ArrayList<>();
// if (possibleSuffixes != null)
// allSuffixes.addAll(possibleSuffixes);
// if (possibleEssencesSuffixes != null)
// allSuffixes.addAll(possibleEssencesSuffixes);
// if (possibleDesecratedSuffixes != null)
// allSuffixes.addAll(possibleDesecratedSuffixes);
...
// System.out.println("\nItem now has " + item.getAllCurrentModifiers().size() +
// " modifiers");
...
// System.out.println("\nTotal: " + existingMods.size() + " existing + " +
// desiredMods.size() + " target = "
// + (existingMods.size() + desiredMods.size()) + " total mods");
...
// System.out.println("\noptimizeCraftingWithExistingMods executed in " +
// durationInMillis + " ms\n");
...
// */
// private static void
// displayResults(List<Probability_Analyzer.CandidateProbability> results,
// double threshold,
...
// int z = 0;
// for (Map.Entry<Crafting_Action, ModifierEvent> entry :
// cp.bestPath().entrySet()) {
...
// if (event.type == ModifierEvent.ActionType.CHANGED && event.changed_modifier
// != null) {
...
// {
// System.out.println(" Omen: " + currency.omen);
// } else if (action instanceof Desecrated_currency currency && currency.omens
// != null) {
// System.out.println(" Omen: " + currency.omens);
// } else if (action instanceof Essence_currency currency && currency.omen !=
// null) {
// System.out.println(" Omen: " + currency.omen);
// }
...
// boolean isExisting = existingMods.stream().anyMatch(em ->
// em.text.equals(m.text));
// boolean isTarget = desiredMods.stream().anyMatch(dm ->
// dm.text.equals(m.text));
// String label = isExisting ? "[EXISTING]" : (isTarget ? "[TARGET]" :
// "[OTHER]");
