...
//PREFIXES
        ...
        DESECRATED_DAMAGE_VS_FULLY_BROKEN_ARMOUR = new Modifier(
            ...
            List.of(
                new ModifierTier("Amanamu's", 65, 1, new Pair<>(86, 99))
            ),
            ModifierType.PREFIX,
        ...
        DESECRATED_EMPOWERED_INCREASED_DAMAGE = new Modifier(
            ...
            List.of(
                new ModifierTier("Kurgal's", 65, 1, new Pair<>(86, 99))
            ),
            ModifierType.PREFIX,
            ModifierSource.DESECRATED,
            "ExertedAttackDamage",
        ...
        DESECRATED_INCREASED_DAMAGE_WHILE_TOTEM = new Modifier(
            ...
            List.of(
                new ModifierTier("Ulaman's", 65, 1, new Pair<>(86, 99))
            ),
            ModifierType.PREFIX,
            ModifierSource.DESECRATED,
            "TotemDamage",
        ...
        DESECRATED_FISSURE_CHANCE = new Modifier(
            ...
            List.of(
                new ModifierTier("of Amanamu", 65, 1, new Pair<>(25, 31))
            ),
            ModifierType.SUFFIX,
            ModifierSource.DESECRATED,
            "FissureChance",
        ...
        DESECRATED_AFTERSHOCK_CHANCE = new Modifier(
            ...
            List.of("amanamu_mod", "attack"),
            List.of(
                new ModifierTier("of Amanamu", 65, 1, new Pair<>(16, 23))
            ),
            ModifierType.SUFFIX,
            ModifierSource.DESECRATED,
            "AftershockChance",
        ...
        DESECRATED_WARCRY_COOLDOWN_SPEED = new Modifier(
            ...
            List.of("kurgal_mod"),
            List.of(
                new ModifierTier("of Kurgal", 65, 1, new Pair<>(25, 31))
            ),
            ModifierType.SUFFIX,
            ModifierSource.DESECRATED,
            "WarcryCooldownSpeed",
        ...
        DESECRATED_TOTEM_PLACEMENT_SPEED = new Modifier(
            ...
            List.of(
                new ModifierTier("of Ulaman", 65, 1, new Pair<>(25, 31))
            ),
            ModifierType.SUFFIX,
            ModifierSource.DESECRATED,
