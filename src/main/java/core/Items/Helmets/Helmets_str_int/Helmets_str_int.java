package core.Items.Helmets.Helmets_str_int;
...
public class Helmets_str_int extends Item_base {

    public Helmets_str_int() {
        ...
        Normal_allowedPrefixes.add(Modifiers_normal.BASE_ARMOUR_ENERGY_SHIELD);
        Normal_allowedPrefixes.add(Modifiers_normal.INCREASED_PERCENT_ARMOUR_ENERGY_SHIELD);
        Normal_allowedPrefixes.add(Modifiers_normal.HYBRID_INCREASED_PERCENT_ARMOUR_ENERGY_SHIELD_AND_LIFE);
        Normal_allowedPrefixes.add(Modifiers_normal.HYBRID_INCREASED_PERCENT_ARMOUR_ENERGY_SHIELD_AND_MANA);
