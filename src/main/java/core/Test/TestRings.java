...
public class TestRings {
	...
	public static void main(String[] args) {
		...
		core.Items.Rings.Rings testItem = new core.Items.Rings.Rings();
		...
		for (Modifier mod : possiblePrefixes) {
			if (mod.text.equals("Adds # to # Fire Damage to Attacks")) {
				desiredMods.add(mod);
		...
		for (Modifier mod : possiblePrefixes) {
			if (mod.text.equals("Adds # to # Cold Damage to Attacks")) {
				desiredMods.add(mod);
		...
		for (Modifier mod : possiblePrefixes) {
			if (mod.text.equals("Adds # to # Lightning Damage to Attacks")) {
				desiredMods.add(mod);
