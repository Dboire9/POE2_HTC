package Item_modifiers.Body_Armours_Item_modifiers.Body_Armours_Normal_Item_modifiers;
...
// PREFIXES
        ...
        HYBRID_BASE_AND_PERCENT_ARMOUR = new Modifier(
            ...
            List.of("defences"),
            List.of(
                new ModifierTier("Abalone's", 8, 1000, new Pair<>(7, 11), new Pair<>(6, 13), "base_armour", "increased_percent_armour"),
                new ModifierTier("Snail's", 16, 1000, new Pair<>(12, 29), new Pair<>(14, 20), "base_armour", "increased_percent_armour"),
                new ModifierTier("Tortoise's", 33, 1000, new Pair<>(30, 39), new Pair<>(21, 26), "base_armour", "increased_percent_armour"),
                new ModifierTier("Pangolin's", 46, 1000, new Pair<>(40, 53), new Pair<>(27, 32), "base_armour", "increased_percent_armour"),
                new ModifierTier("Shelled", 60, 1000, new Pair<>(54, 69), new Pair<>(33, 38), "base_armour", "increased_percent_armour"),
                new ModifierTier("Hardened", 78, 1000, new Pair<>(70, 86), new Pair<>(39, 42), "base_armour", "increased_percent_armour")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
        ...
        HYBRID_BASE_AND_PERCENT_EVASION = new Modifier(
            ...
            List.of("defences"),
            List.of(
                new ModifierTier("Impala's", 8, 1000, new Pair<>(5, 8), new Pair<>(6, 13), "base_evasion", "increased_percent_evasion"),
                new ModifierTier("Buck's", 16, 1000, new Pair<>(9, 24), new Pair<>(14, 20), "base_evasion", "increased_percent_evasion"),
                new ModifierTier("Moose's", 33, 1000, new Pair<>(25, 34), new Pair<>(21, 26), "base_evasion", "increased_percent_evasion"),
                new ModifierTier("Deer's", 46, 1000, new Pair<>(35, 47), new Pair<>(27, 32), "base_evasion", "increased_percent_evasion"),
                new ModifierTier("Caribou's", 60, 1000, new Pair<>(48, 62), new Pair<>(33, 38), "base_evasion", "increased_percent_evasion"),
                new ModifierTier("Antelope's", 78, 1000, new Pair<>(63, 79), new Pair<>(39, 42), "base_evasion", "increased_percent_evasion")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "BaseLocalDefencesAndDefencePercent",
        ...
        HYBRID_BASE_AND_PERCENT_ENERGY_SHIELD = new Modifier(
            ...
            List.of("defences"),
            List.of(
                new ModifierTier("Deacon's", 8, 1000, new Pair<>(4, 7), new Pair<>(6, 13), "base_energy_shield", "increased_percent_energy_shield"),
                new ModifierTier("Cardinal's", 16, 1000, new Pair<>(8, 13), new Pair<>(14, 20), "base_energy_shield", "increased_percent_energy_shield"),
                new ModifierTier("Priest's", 33, 1000, new Pair<>(14, 16), new Pair<>(21, 26), "base_energy_shield", "increased_percent_energy_shield"),
                new ModifierTier("High Priest's", 46, 1000, new Pair<>(17, 20), new Pair<>(27, 32), "base_energy_shield", "increased_percent_energy_shield"),
                new ModifierTier("Archon's", 60, 1000, new Pair<>(21, 25), new Pair<>(33, 38), "base_energy_shield", "increased_percent_energy_shield"),
                new ModifierTier("Divine", 78, 1000, new Pair<>(26, 30), new Pair<>(39, 42), "base_energy_shield", "increased_percent_energy_shield")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "BaseLocalDefencesAndDefencePercent",
