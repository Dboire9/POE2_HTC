...
public class Modifiers_normal {
    ...
    static {
        ...
        List.of(
            new ModifierTier("Heated", 1, 1200, new Pair<>(1, 2), new Pair<>(3, 5), "", ""),
            new ModifierTier("Smouldering", 8, 1200, new Pair<>(4, 6), new Pair<>(7, 10), "", ""),
            new ModifierTier("Smoking", 16, 1200, new Pair<>(7, 11), new Pair<>(13, 19), "", ""),
            new ModifierTier("Burning", 33, 1200, new Pair<>(13, 19), new Pair<>(21, 29), "", ""),
            new ModifierTier("Flaming", 46, 1200, new Pair<>(20, 24), new Pair<>(32, 37), "", ""),
            new ModifierTier("Scorching", 54, 1200, new Pair<>(25, 33), new Pair<>(38, 54), "", ""),
            new ModifierTier("Incinerating", 60, 720, new Pair<>(35, 44), new Pair<>(56, 71), "", ""),
            new ModifierTier("Blasting", 65, 480, new Pair<>(47, 59), new Pair<>(74, 97), "", ""),
            new ModifierTier("Cremating", 75, 300, new Pair<>(62, 85), new Pair<>(101, 129), "", ""),
            new ModifierTier("Carbonising", 81, 120, new Pair<>(88, 101), new Pair<>(133, 154), "", "")
        ),
        Modifier.ModifierType.PREFIX,
        Modifier.ModifierSource.NORMAL,
        "FireDamage",
        ...
        LIGHTNING_DAMAGE_FLAT = new Modifier(
            ...
            List.of(
                new ModifierTier("Humming", 1, 800, new Pair<>(1, 1), new Pair<>(4, 6), "", ""),
                new ModifierTier("Buzzing", 8, 800, new Pair<>(1, 1), new Pair<>(13, 19), "", ""),
                new ModifierTier("Snapping", 16, 800, new Pair<>(1, 2), new Pair<>(20, 30), "", ""),
                new ModifierTier("Crackling", 33, 800, new Pair<>(1, 2), new Pair<>(36, 52), "", ""),
                new ModifierTier("Sparking", 46, 800, new Pair<>(1, 3), new Pair<>(55, 60), "", ""),
                new ModifierTier("Arcing", 54, 800, new Pair<>(1, 4), new Pair<>(63, 82), "", ""),
                new ModifierTier("Shocking", 60, 480, new Pair<>(1, 6), new Pair<>(85, 107), "", ""),
                new ModifierTier("Discharging", 65, 320, new Pair<>(1, 8), new Pair<>(111, 152), "", ""),
                new ModifierTier("Electrocuting", 75, 200, new Pair<>(1, 10), new Pair<>(157, 196), "", ""),
                new ModifierTier("Vapourising", 81, 80, new Pair<>(1, 12), new Pair<>(202, 234), "", "")
            ),
            Modifier.ModifierType.PREFIX,
            Modifier.ModifierSource.NORMAL,
            "LightningDamage",
...
//SUFFIXES
        ...
        LEVEL_MELEE_SKILL = new Modifier(
            ...
            List.of("attack"),
            List.of(
                new ModifierTier("of Combat", 2, 1000, new Pair<>(1, 1)),
                new ModifierTier("of Dueling", 18, 750, new Pair<>(2, 2)),
                new ModifierTier("of Conflict", 36, 500, new Pair<>(3, 3)),
                new ModifierTier("of Battle", 55, 250, new Pair<>(4, 4)),
                new ModifierTier("of War", 81, 100, new Pair<>(5, 5))
            ),
            ModifierType.SUFFIX,
            ModifierSource.NORMAL,
